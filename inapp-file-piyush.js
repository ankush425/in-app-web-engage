...
if (result.win === "no") {
    ...
    document
        ...
        .insertAdjacentHTML(
            "beforeend",
            `<code><p>You Won Exclusive Coupon</p><p><b>${result.code}<b></p><img src='https://d3gfjdwfdb7zi0.cloudfront.net/in-app-scratch/assets/Icon.svg' alt='copy-code-icon' srcset='' style="width:20px;"><span id='code'>âœ“</span></code>`
        );
    document.querySelector(".winScreen code p").innerHTML =
        `<p>You Won Exclusive Coupon</p><p><b>${result.code}</b></p>`;
